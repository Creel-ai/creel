"""Process manager for dev session containers.

Canonical source: src/bridge/process_manager.py
Copied into executor context for Docker builds. Keep in sync.

Spawns, manages, and monitors background processes.
